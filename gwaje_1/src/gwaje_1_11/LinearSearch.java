package gwaje_1_11;
//선형 탐색 
//배열 a로부터 key와 같은 값을 가지는 요소를 탐색하는 메소드 작성
//단 키와 같은 값을 가지는 요소가 여러 개인 경우 search는 가장 앞에 위치한 요소, 
//searchr은 가장 뒤에 위치한 요소 찾을 것
...
class LinearSearch {
	...
	public static void main(String[] args) {
		...
		if(idxTop == -1)
			...
			System.out.println("가장 앞에 위치한 값은 x[" + idxTop + "]입니다.");
			System.out.println("가장 뒤에 위치한 값은 x[" + idxBtm + "]입니다.");
		}
	}
}
